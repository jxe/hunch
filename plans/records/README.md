# Completed extraction records

These files preserve verification evidence and research from completed stages
of the Quagmire extraction. They are records, not active executor plans.

- `editor-extraction-baseline.md` — Milestones 0–2
